...
- passing information along
   - knowing when/where to get data

- optimistic rendering

- conditional logical rendering
   - where should logic go?
   - putting logic in JS vs backend?


## User Stories
As a user, I can see all the trainers and pokemon

I can release a pokemon

I can Add a pokemon to a trainer's team IF there are less than 6


3 pillars of web dev
event => fetch => DOM
- When the DOMContentLoaded, make GET fetch to /trainers, render each trainer to page
- When a 'Release' button is click => remove the li => make a DELETE fetch

- When an 'Add Pokemon' button is click => fetch POST to /pokemons => add the li to the ul
